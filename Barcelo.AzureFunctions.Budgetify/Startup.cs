...
namespace Barcelo.AzureFunctions.Budgetify
{
    public class Startup : FunctionsStartup
    {
        ...
        {
            builder.Services.AddTransient <IUserBudgetVotingRunner, UserBudgetVotingRunner>();
            builder.Services.AddTransient<IGetBudgetsByUserIdRunner, GetBudgetsByUserIdRunner>();
            ...
            builder.Services.AddTransient<IGetBudgetsByCompanyIdRunner, GetBudgetsByCompanyIdRunner>();
            builder.Services.AddTransient<IUpdateProposalRunner, UpdateProposalRunner>();
        }
    }
}
